Источником данных является файл Данные(1). Работа осуществлялась в графическом инструменте pgadmin4(PostgreSQL). Импорт данных осущствлялся с помощью встренной функции Import/export Data.
